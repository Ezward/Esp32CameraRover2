...
int strCopySize(char *dest, const int destSize, const char *source, const int sourceSize);
int strCopyAt(char *dest, int destSize, int destIndex, const char *source);
int strCopySizeAt(char *dest, const int destSize, const int destIndex, const char *source, const int sourceSize);
